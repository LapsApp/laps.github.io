						   ...
						   ?>
                              ...
                              <div class="form-group"><br>
                                 ...
                                 <div class="col-lg-4">
                                    ...
                                    <input name="foto" type="file" id="foto" <?php if($desabilitar) { echo "disabled"; } ?> onchange="readURL(this,'fotoimg');" required />
                                 </div>
                              </div>
                              <div class="form-group ">
                                 ...
                                 <div class="col-lg-2">
                                    <input class="form-control" id="subject" <?php if($desabilitar) { echo "disabled value='".$data_cli['rg']."'"; } ?> name="rg" maxlength="10" type="text" required />
                                 </div>
                                 <label for="cname" class="control-label col-lg-2">Renda Bruta R$<span class="required">*</span></label>
                                 <div class="col-lg-2">
                                    <input class="form-control" id="subject" <?php if($desabilitar) { echo "disabled value='".$data_con['renda']."'"; } ?> name="renda" type="text" required />
                                 </div>
                                 <label for="cname" class="control-label col-lg-2" >Telefone<span class="required">*</span></label>
                                 <div class="col-lg-2">
                                    <input class="form-control" id="subject" <?php if($desabilitar) { echo "disabled value='".$data_cli['cel']."'"; } ?> name="cel" maxlength="9" type="text" required />
                                 </div>
                              </div>
                              ...
                              <div class="form-group ">
                                 ...
                                 <div class="col-lg-6">
                                    <input class="form-control" <?php if($desabilitar) { echo "disabled value='".$data_end['rua']."'"; } ?> id="subject" name="rua" maxlength="20" type="text" required />
                                 </div>

                                 <label for="cname" class="control-label col-lg-2">Numero<span class="required">*</span></label>
                                 <div class="col-lg-2">
                                    <input class="form-control" id="subject" name="numero" maxlength="8" type="text" required <?php if($desabilitar) { echo "disabled value='".$data_end['num']."'"; } ?> />
                                 </div>
                              </div>
                              ...
                              <div class="form-group ">
                                 ...
                                 <div class="col-lg-6">
                                    <input class="form-control" id="subject" name="complemento" maxlength="20" type="text" <?php if($desabilitar) { echo "disabled value='".$data_end['complemento']."'"; } ?>/>
                                 </div>

                                 <label for="cname" class="control-label col-lg-2">Cep<span class="required">*</span></label>
                                 <div class="col-lg-2">
                                    <input class="form-control" id="subject" name="cep" maxlength="8" type="text" required <?php if($desabilitar) { echo "disabled value='".$data_end['cep']."'"; } ?> />
                                 </div>
                              </div>
							  ...
							  <label for="cname" class="control-label col-lg-2">Bairro <span class="required" >*</span></label>
                                 <div class="col-lg-2">
                                    <input class="form-control" id="subject" name="bairro" type="text" required <?php if($desabilitar) { echo "disabled value='".$data_end['bairro']."'"; } ?> />
                                 </div>
                                 <label for="cname" class="control-label col-lg-2">Cidade <span class="required">*</span></label>
                                 <div class="col-lg-2">
                                    <input class="form-control" id="subject" name="cidade" type="text" required <?php if($desabilitar) { echo "disabled value='".$data_end['cidade']."'"; } ?> />
                                 </div>

                                 <label for="cname" class="control-label col-lg-2">Estado <span class="required" >*</span></label>
                                 <div class="col-lg-1">
                                    <input class="form-control" id="subject" name="estado" maxlength="2" type="text" required <?php if($desabilitar) { echo "disabled value='".$data_end['estado']."'"; } ?> />
                                 </div>
                              </div>
                              ...
                              <div class="form-group"><br>
                                 ...
                                 <div class="col-lg-4">
                                    ...
                                    <input name="frente" type="file" id="frente" onchange="readURL(this,'frenteimg');" required <?php if($desabilitar) { echo "disabled"; } ?> />
                                 </div>
                                 ...
                                 <div class="col-lg-4">
                                    ...
                                    <input name="verso" type="file" id="verso" onchange="readURL(this,'versoimg');" required <?php if($desabilitar) { echo "disabled"; } ?> />
                                 </div>
                              </div>
