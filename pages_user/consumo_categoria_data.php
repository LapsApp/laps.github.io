                ...
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
							...
							<form action="./consumo_categoria.php" method="post">
									<div class="panel-body">
										<table width="1100" border="0" align="center"> 
											<tr>
												<td align="center">
													<b>PERÍODO</b><br><br>
													DATA INÍCIAL: <input id="dt_inicial" name="dt_inicial" type="date" required>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													DATA FINAL: <input id="dt_final" name="dt_final" id="piechart" type="date" required>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="hidden" name="id_cliente" value="<?php echo $id_cliente;?>">
													
													<input class='btn btn-primary' name='gerar' type="submit" value="GERAR GRÁFICO DE CONSUMO"><br><br>
												</td>
											</tr>
