                            ...
                            <div class="panel-body">
                                <table width="1100" border="0" align="center"> 
                                    ...
                                    <th><h4><b></b></h4></th></tr>";
                                          ...
                                          <td align='right'>R$" . str_replace('.', ',', $valor) . "</td>";
                                                                $i++;
                                                            ...
                                                            echo "</tr></table><h4 align='right'><b> VALOR TOTAL = R$" . str_replace('.', ',', $valorfm) . "                                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></h4><br><br>";
                                                            if ($pgto == 1) {
                                    ...
                                    <th><h4><b></b></h4></th></tr>";
                                          ...
                                          <td align='right'>R$" . str_replace('.', ',', $valor) . "</td>";
                                                            ...
                                                            echo "</tr></table><h4 align='right'><b> VALOR TOTALl = R$" . $valorfm . "                                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></h4><br><br>";
                                                            if ($pgto == 1) {
                                                                echo "<h4 align='center' style='color: green'><b>FATURA PAGA</b></h4>";
                                                            }
                                                        } else {
