...
<body style="margin: 0px; padding: 0px; height: 100%; width:100%;">
    ...
    <div id="barra" style="line-height: 40px"><b>
        ...
        <select class="postform" id="cat" name="cat" width="500" onchange="location=this.options[this.selectedIndex].value;">
            ...
            <option value="../loja/lojaonline.php?cat=GERAL">GERAL</option>
            <option value="../loja/lojaonline.php?cat=ALIMENTACAO">ALIMENTACAO</option>
            <option value="../loja/lojaonline.php?cat=TECNOLOGIA">TECNOLOGIA</option>
            <option value="../loja/lojaonline.php?cat=LIVRARIA">LIVRARIA</option>
            <option value="../loja/lojaonline.php?cat=ESPORTE">ESPORTE</option>
            <option value="../loja/lojaonline.php?cat=LAZER">LAZER</option>
            <option value="../loja/lojaonline.php?cat=CALCADO">CALCADOS</option>
            <option value="../loja/lojaonline.php?cat=VESTUARIO">VESTUARIO</option>
            <option value="../loja/lojaonline.php?cat=ELETRODOMESTICO">ELETRODOMESTICO</option>
        </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
