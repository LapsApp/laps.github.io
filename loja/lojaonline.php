    ...
    <body style="margin: 0px; padding: 0px; height: 100%; width:100%;">
        ...
        <table align="center" width="1100" border="0" cellspacing="30"> 
            <tr>
                ...
                if ($cat != 'GERAL') {
                    $sql = "SELECT id_prod, nome, estoque, valor, categoria, id_loja, foto FROM Produto WHERE categoria='" . $cat . "' ORDER BY nome";
                } else {
                    $sql = "SELECT id_prod, nome, estoque, valor, categoria, id_loja, foto FROM Produto ORDER BY nome";
                }
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        if ($row["categoria"] == "ALIMENTACAO") {
                            echo "<div style='width: 250px; height: 380px; background: #FF9999; color: #000; box-shadow: 0px 20px 15px grey'>";
                        }
                        if ($row["categoria"] == "TECNOLOGIA") {
                            echo "<div style='width: 250px; height: 380px; background: #CCFFE5; color: #000; box-shadow: 0px 20px 15px grey'>";
                        }
                        if ($row["categoria"] == "LIVRARIA") {
                            echo "<div style='width: 250px; height: 380px; background: #FFE5CC; color: #000; box-shadow: 0px 20px 15px grey'>";
                        }
                        if ($row["categoria"] == "ESPORTE") {
                            echo "<div style='width: 250px; height: 380px; background: #CCFF99; color: #000; box-shadow: 0px 20px 15px grey'>";
                        }
                        if ($row["categoria"] == "LAZER") {
                            echo "<div style='width: 250px; height: 380px; background: #C6E2FF; color: #000; box-shadow: 0px 20px 15px grey'>";
                        }
                        if ($row["categoria"] == "CALCADO") {
                            echo "<div style='width: 250px; height: 380px; background: #EEDD82; color: #000; box-shadow: 0px 20px 15px grey'>";
                        }
                        if ($row["categoria"] == "VESTUARIO") {
                            echo "<div style='width: 250px; height: 380px; background: #FFBBFF; color: #000; box-shadow: 0px 20px 15px grey'>";
                        }
                        if ($row["categoria"] == "ELETRODOMESTICO") {
                            echo "<div style='width: 250px; height: 380px; background: #CFCFCF; color: #000; box-shadow: 0px 20px 15px grey'>";
                        }
//                        <br><b>" . $row["id_loja"] . "</b>
                        echo "<br><br>
<div id='img'><img src='images/" . $row["foto"] . "'>
